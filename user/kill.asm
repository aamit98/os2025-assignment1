...
main(int argc, char **argv)
{
  ...
  42:	81a58593          	addi	a1,a1,-2022 # 858 <malloc+0x106>
  46:	4501                	li	a0,0
  48:	00000097          	auipc	ra,0x0
  4c:	2bc080e7          	jalr	700(ra) # 304 <exit>
    fprintf(2, "usage: kill pid...\n");
  50:	00000597          	auipc	a1,0x0
  54:	7f058593          	addi	a1,a1,2032 # 840 <malloc+0xee>
  58:	4509                	li	a0,2
  5a:	00000097          	auipc	ra,0x0
  5e:	60c080e7          	jalr	1548(ra) # 666 <fprintf>
    exit(1,"");
  62:	00000597          	auipc	a1,0x0
  66:	7f658593          	addi	a1,a1,2038 # 858 <malloc+0x106>
  6a:	4505                	li	a0,1
...
_main()
{
  ...
  88:	7d458593          	addi	a1,a1,2004 # 858 <malloc+0x106>
  8c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	46850513          	addi	a0,a0,1128 # 868 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	39cb8b93          	addi	s7,s7,924 # 868 <digits>
 ...
 610:	25490913          	addi	s2,s2,596 # 860 <malloc+0x10e>
        while(*s != 0){
