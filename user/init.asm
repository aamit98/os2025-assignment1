...
main(void)
{
  ...
  14:	8d050513          	addi	a0,a0,-1840 # 8e0 <malloc+0xe6>
  ...
  3c:	8b098993          	addi	s3,s3,-1872 # 8e8 <malloc+0xee>
    }
  ...
  44:	8d890913          	addi	s2,s2,-1832 # 918 <malloc+0x11e>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  4a:	00000097          	auipc	ra,0x0
  4e:	6f2080e7          	jalr	1778(ra) # 73c <printf>
    pid = fork();
  ...
  7a:	8ca50513          	addi	a0,a0,-1846 # 940 <malloc+0x146>
  7e:	00000097          	auipc	ra,0x0
  82:	6be080e7          	jalr	1726(ra) # 73c <printf>
        exit(1,"");
  86:	00001597          	auipc	a1,0x1
  8a:	89258593          	addi	a1,a1,-1902 # 918 <malloc+0x11e>
  8e:	4505                	li	a0,1
  ...
  a0:	84450513          	addi	a0,a0,-1980 # 8e0 <malloc+0xe6>
  a4:	00000097          	auipc	ra,0x0
  a8:	350080e7          	jalr	848(ra) # 3f4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	83250513          	addi	a0,a0,-1998 # 8e0 <malloc+0xe6>
  b6:	00000097          	auipc	ra,0x0
  ba:	336080e7          	jalr	822(ra) # 3ec <open>
  be:	b79d                	j	24 <main+0x24>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	84050513          	addi	a0,a0,-1984 # 900 <malloc+0x106>
  c8:	00000097          	auipc	ra,0x0
  cc:	674080e7          	jalr	1652(ra) # 73c <printf>
      exit(1,"");
  d0:	00001597          	auipc	a1,0x1
  d4:	84858593          	addi	a1,a1,-1976 # 918 <malloc+0x11e>
  d8:	4505                	li	a0,1
  ...
  ee:	83650513          	addi	a0,a0,-1994 # 920 <malloc+0x126>
  f2:	00000097          	auipc	ra,0x0
  f6:	2f2080e7          	jalr	754(ra) # 3e4 <exec>
      printf("init: exec sh failed\n");
  fa:	00001517          	auipc	a0,0x1
  fe:	82e50513          	addi	a0,a0,-2002 # 928 <malloc+0x12e>
 102:	00000097          	auipc	ra,0x0
 106:	63a080e7          	jalr	1594(ra) # 73c <printf>
      exit(1,"");
 10a:	00001597          	auipc	a1,0x1
 10e:	80e58593          	addi	a1,a1,-2034 # 918 <malloc+0x11e>
 112:	4505                	li	a0,1
...
_main()
{
 ...
 130:	7ec58593          	addi	a1,a1,2028 # 918 <malloc+0x11e>
 134:	4501                	li	a0,0
...
putc(int fd, char c)
{
 ...
 47a:	f56080e7          	jalr	-170(ra) # 3cc <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	4c050513          	addi	a0,a0,1216 # 968 <digits>
 4b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 578:	3f4b8b93          	addi	s7,s7,1012 # 968 <digits>
 ...
 6b8:	2ac90913          	addi	s2,s2,684 # 960 <malloc+0x166>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8d2:	b66080e7          	jalr	-1178(ra) # 434 <sbrk>
  if(p == (char*)-1)
