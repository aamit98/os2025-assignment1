...
main(void)
{
  ...
  14:	8c050513          	addi	a0,a0,-1856 # 8d0 <malloc+0xe6>
  ...
  3c:	8a098993          	addi	s3,s3,-1888 # 8d8 <malloc+0xee>
    }
  ...
  44:	8c890913          	addi	s2,s2,-1848 # 908 <malloc+0x11e>
    printf("init: starting sh\n");
  48:	854e                	mv	a0,s3
  4a:	00000097          	auipc	ra,0x0
  4e:	6e2080e7          	jalr	1762(ra) # 72c <printf>
    pid = fork();
  ...
  7a:	8ba50513          	addi	a0,a0,-1862 # 930 <malloc+0x146>
  7e:	00000097          	auipc	ra,0x0
  82:	6ae080e7          	jalr	1710(ra) # 72c <printf>
        exit(1,"");
  86:	00001597          	auipc	a1,0x1
  8a:	88258593          	addi	a1,a1,-1918 # 908 <malloc+0x11e>
  8e:	4505                	li	a0,1
  ...
  a0:	83450513          	addi	a0,a0,-1996 # 8d0 <malloc+0xe6>
  a4:	00000097          	auipc	ra,0x0
  a8:	350080e7          	jalr	848(ra) # 3f4 <mknod>
    open("console", O_RDWR);
  ac:	4589                	li	a1,2
  ae:	00001517          	auipc	a0,0x1
  b2:	82250513          	addi	a0,a0,-2014 # 8d0 <malloc+0xe6>
  b6:	00000097          	auipc	ra,0x0
  ba:	336080e7          	jalr	822(ra) # 3ec <open>
  be:	b79d                	j	24 <main+0x24>
      printf("init: fork failed\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	83050513          	addi	a0,a0,-2000 # 8f0 <malloc+0x106>
  c8:	00000097          	auipc	ra,0x0
  cc:	664080e7          	jalr	1636(ra) # 72c <printf>
      exit(1,"");
  d0:	00001597          	auipc	a1,0x1
  d4:	83858593          	addi	a1,a1,-1992 # 908 <malloc+0x11e>
  d8:	4505                	li	a0,1
  ...
  ee:	82650513          	addi	a0,a0,-2010 # 910 <malloc+0x126>
  f2:	00000097          	auipc	ra,0x0
  f6:	2f2080e7          	jalr	754(ra) # 3e4 <exec>
      printf("init: exec sh failed\n");
  fa:	00001517          	auipc	a0,0x1
  fe:	81e50513          	addi	a0,a0,-2018 # 918 <malloc+0x12e>
 102:	00000097          	auipc	ra,0x0
 106:	62a080e7          	jalr	1578(ra) # 72c <printf>
      exit(1,"");
 10a:	00000597          	auipc	a1,0x0
 10e:	7fe58593          	addi	a1,a1,2046 # 908 <malloc+0x11e>
 112:	4505                	li	a0,1
...
_main()
{
 ...
 130:	7dc58593          	addi	a1,a1,2012 # 908 <malloc+0x11e>
 134:	4501                	li	a0,0
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 568:	3f4b8b93          	addi	s7,s7,1012 # 958 <digits>
 ...
 6a8:	2ac90913          	addi	s2,s2,684 # 950 <malloc+0x166>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 83a:	7da90913          	addi	s2,s2,2010 # 1010 <freep>
  if(p == (char*)-1)
 83e:	5afd                	li	s5,-1
 ...
 8c2:	b76080e7          	jalr	-1162(ra) # 434 <sbrk>
  if(p == (char*)-1)
