...
main(int argc, char *argv[])
{
  ...
  7e:	7e658593          	addi	a1,a1,2022 # 860 <malloc+0xf6>
  82:	4501                	li	a0,0
...
_main()
{
  ...
  a0:	7c458593          	addi	a1,a1,1988 # 860 <malloc+0xf6>
  a4:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41c:	45850513          	addi	a0,a0,1112 # 870 <digits>
 420:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e8:	38cb8b93          	addi	s7,s7,908 # 870 <digits>
 ...
 628:	24490913          	addi	s2,s2,580 # 868 <malloc+0xfe>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 842:	b66080e7          	jalr	-1178(ra) # 3a4 <sbrk>
  if(p == (char*)-1)
