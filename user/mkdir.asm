...
main(int argc, char *argv[])
{
  ...
  54:	81858593          	addi	a1,a1,-2024 # 868 <malloc+0x102>
  58:	4505                	li	a0,1
  ...
  68:	80c58593          	addi	a1,a1,-2036 # 870 <malloc+0x10a>
  6c:	4509                	li	a0,2
  ...
  7a:	7f258593          	addi	a1,a1,2034 # 868 <malloc+0x102>
  7e:	4501                	li	a0,0
...
_main()
{
  ...
  9c:	7d058593          	addi	a1,a1,2000 # 868 <malloc+0x102>
  a0:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 418:	48450513          	addi	a0,a0,1156 # 898 <digits>
 41c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4e4:	3b8b8b93          	addi	s7,s7,952 # 898 <digits>
 ...
 624:	27090913          	addi	s2,s2,624 # 890 <malloc+0x12a>
        while(*s != 0){
