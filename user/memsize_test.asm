...
main(int argc, char *argv[])
{
   ...
   e:	3aa080e7          	jalr	938(ra) # 3b4 <memsize>
  12:	85aa                	mv	a1,a0
    printf("start: %d\n",(int)ms);
  ...
  2e:	728080e7          	jalr	1832(ra) # 752 <malloc>
  32:	84aa                	mv	s1,a0
    ms = memsize();
  34:	00000097          	auipc	ra,0x0
  38:	380080e7          	jalr	896(ra) # 3b4 <memsize>
  3c:	85aa                	mv	a1,a0
    printf("after adding: %d\n",(int)ms);
  3e:	00001517          	auipc	a0,0x1
  42:	81250513          	addi	a0,a0,-2030 # 850 <malloc+0xfe>
  46:	00000097          	auipc	ra,0x0
  4a:	64e080e7          	jalr	1614(ra) # 694 <printf>

    free(temp);
  4e:	8526                	mv	a0,s1
  50:	00000097          	auipc	ra,0x0
  54:	67a080e7          	jalr	1658(ra) # 6ca <free>
    ms = memsize();
  58:	00000097          	auipc	ra,0x0
  5c:	35c080e7          	jalr	860(ra) # 3b4 <memsize>
  60:	85aa                	mv	a1,a0
    printf("after freeing: %d\n",(int)ms);
  62:	00001517          	auipc	a0,0x1
  66:	80650513          	addi	a0,a0,-2042 # 868 <malloc+0x116>
  6a:	00000097          	auipc	ra,0x0
  6e:	62a080e7          	jalr	1578(ra) # 694 <printf>


    exit(0,"");
  72:	00001597          	auipc	a1,0x1
  76:	80e58593          	addi	a1,a1,-2034 # 880 <malloc+0x12e>
  7a:	4501                	li	a0,0
...
_main()
{
  ...
  98:	7ec58593          	addi	a1,a1,2028 # 880 <malloc+0x12e>
  9c:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 404:	49050513          	addi	a0,a0,1168 # 890 <digits>
 408:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d0:	3c4b8b93          	addi	s7,s7,964 # 890 <digits>
 ...
 610:	27c90913          	addi	s2,s2,636 # 888 <malloc+0x136>
        while(*s != 0){
