...
main(int argc, char *argv[])
{
  ...
  2e:	718080e7          	jalr	1816(ra) # 742 <malloc>
  32:	84aa                	mv	s1,a0
    ms = memsize();
  34:	00000097          	auipc	ra,0x0
  38:	370080e7          	jalr	880(ra) # 3a4 <memsize>
  3c:	85aa                	mv	a1,a0
    printf("after adding: %d\n",(int)ms);
  3e:	00001517          	auipc	a0,0x1
  42:	80250513          	addi	a0,a0,-2046 # 840 <malloc+0xfe>
  46:	00000097          	auipc	ra,0x0
  4a:	63e080e7          	jalr	1598(ra) # 684 <printf>

    free(temp);
  4e:	8526                	mv	a0,s1
  50:	00000097          	auipc	ra,0x0
  54:	66a080e7          	jalr	1642(ra) # 6ba <free>
    ms = memsize();
  58:	00000097          	auipc	ra,0x0
  5c:	34c080e7          	jalr	844(ra) # 3a4 <memsize>
  60:	85aa                	mv	a1,a0
    printf("after freeing: %d\n",(int)ms);
  62:	00000517          	auipc	a0,0x0
  66:	7f650513          	addi	a0,a0,2038 # 858 <malloc+0x116>
  6a:	00000097          	auipc	ra,0x0
  6e:	61a080e7          	jalr	1562(ra) # 684 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	48850513          	addi	a0,a0,1160 # 878 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	3bcb8b93          	addi	s7,s7,956 # 878 <digits>
 ...
 600:	27490913          	addi	s2,s2,628 # 870 <malloc+0x12e>
        while(*s != 0){
