...
main(int argc, char *argv[])
{
  ...
  18:	83c50513          	addi	a0,a0,-1988 # 850 <malloc+0xee>
  1c:	00000097          	auipc	ra,0x0
  20:	688080e7          	jalr	1672(ra) # 6a4 <printf>
    
    int* temp = (int*)malloc(20000);
  24:	6515                	lui	a0,0x5
  26:	e2050513          	addi	a0,a0,-480 # 4e20 <base+0x3e10>
  2a:	00000097          	auipc	ra,0x0
  2e:	738080e7          	jalr	1848(ra) # 762 <malloc>
  32:	84aa                	mv	s1,a0
    ms = memsize();
  ...
  42:	82250513          	addi	a0,a0,-2014 # 860 <malloc+0xfe>
  46:	00000097          	auipc	ra,0x0
  4a:	65e080e7          	jalr	1630(ra) # 6a4 <printf>

    free(temp);
  4e:	8526                	mv	a0,s1
  50:	00000097          	auipc	ra,0x0
  54:	68a080e7          	jalr	1674(ra) # 6da <free>
    ms = memsize();
  ...
  66:	81650513          	addi	a0,a0,-2026 # 878 <malloc+0x116>
...
_main()
{
  ...
  98:	7fc58593          	addi	a1,a1,2044 # 890 <malloc+0x12e>
  9c:	4501                	li	a0,0
