...
main(int argc, char *argv[])
{
  ...
  1a:	90278793          	addi	a5,a5,-1790 # 918 <malloc+0x11e>
  1e:	6398                	ld	a4,0(a5)
...
//    printf(fd, "%d\n", i);
  ...
  fc:	81858593          	addi	a1,a1,-2024 # 910 <malloc+0x116>
 100:	4501                	li	a0,0
 ...
 10e:	80658593          	addi	a1,a1,-2042 # 910 <malloc+0x116>
 112:	4501                	li	a0,0
...
_main()
{
 ...
 130:	7e458593          	addi	a1,a1,2020 # 910 <malloc+0x116>
 134:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ac:	48850513          	addi	a0,a0,1160 # 930 <digits>
 4b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 578:	3bcb8b93          	addi	s7,s7,956 # 930 <digits>
 ...
 6b8:	27490913          	addi	s2,s2,628 # 928 <malloc+0x12e>
        while(*s != 0){
