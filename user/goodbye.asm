...
main(int argc, char *argv[])
{
   ...
   c:	7d858593          	addi	a1,a1,2008 # 7e0 <malloc+0xe8>
  10:	4501                	li	a0,0
...
_main()
{
  ...
  2e:	7ce58593          	addi	a1,a1,1998 # 7f8 <malloc+0x100>
  32:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 7d0:	b66080e7          	jalr	-1178(ra) # 332 <sbrk>
  if(p == (char*)-1)
