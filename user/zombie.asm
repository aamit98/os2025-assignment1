...
main(void)
{
  ...
  18:	7ec58593          	addi	a1,a1,2028 # 800 <malloc+0xf0>
  1c:	4501                	li	a0,0
...
_main()
{
  ...
  46:	7be58593          	addi	a1,a1,1982 # 800 <malloc+0xf0>
  4a:	4501                	li	a0,0
...
malloc(uint nbytes)
{
 ...
 7e8:	b66080e7          	jalr	-1178(ra) # 34a <sbrk>
  if(p == (char*)-1)
