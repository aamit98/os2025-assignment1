...
main(int argc, char *argv[])
{
  ...
  1e:	290080e7          	jalr	656(ra) # 2aa <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39a:	45250513          	addi	a0,a0,1106 # 7e8 <digits>
 39e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 466:	386b8b93          	addi	s7,s7,902 # 7e8 <digits>
 ...
 5a6:	23e90913          	addi	s2,s2,574 # 7e0 <malloc+0xf8>
        while(*s != 0){
