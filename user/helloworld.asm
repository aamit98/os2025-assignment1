...
main(int argc, char *argv[])
{
  ...
  1c:	7e858593          	addi	a1,a1,2024 # 800 <malloc+0xf8>
  20:	4501                	li	a0,0
...
_main()
{
  ...
  3e:	7c658593          	addi	a1,a1,1990 # 800 <malloc+0xf8>
  42:	4501                	li	a0,0
  44:	00000097          	auipc	ra,0x0
  48:	276080e7          	jalr	630(ra) # 2ba <exit>
...
gets(char *buf, int max)
{
 ...
 13a:	19c080e7          	jalr	412(ra) # 2d2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 18c:	172080e7          	jalr	370(ra) # 2fa <open>
  if(fd < 0)
 ...
 19c:	17a080e7          	jalr	378(ra) # 312 <fstat>
 1a0:	892a                	mv	s2,a0
  close(fd);
 1a2:	8526                	mv	a0,s1
 1a4:	00000097          	auipc	ra,0x0
 1a8:	13e080e7          	jalr	318(ra) # 2e2 <close>
  return r;
}
 1ac:	854a                	mv	a0,s2
